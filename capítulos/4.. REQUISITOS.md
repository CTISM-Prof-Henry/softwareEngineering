...
No desenvolvimento ágil, os requisitos são levantados ao mesmo tempo em que o sistema está sendo desenvolvido, por
meio de iterações chamadas _sprints_. Já no desenvolvimento usando outros modelos de processo de software, principalmente
...
![requisitos.jpg](../imagens/requisitos.jpg)

![requisitos_2.png](../imagens/requisitos_2.png)
...
A concepção é quando se percebe que será necessário um novo software para resolver um problema existente, ou aproveitar
...
pedindo para escolher os que devem ser implementados antes.
...
Durante a engenharia de requisitos, pode ser importante gerar um protótipo do software, para que os clientes e usuários
possam visualizar como o software irá funcionar, e para que a equipe de desenvolvimento possa validar se o que foi
levantado é realmente o que os clientes e usuários desejam. O protótipo pode ser feito em papel, ou utilizando
ferramentas como o [Figma](https://www.figma.com/), que permitem criar protótipos navegáveis, simulando a interação do 
usuário com o software.

## Atividade

Nesta atividade, você deve levantar os requisitos de um software. O software consiste em um requisito que o professor
passará em aula.

Você deve levantar os requisitos da melhor maneira possível, com as limitações impostas. Depois, um de seus colegas irá
revisar seus requisitos, e você revisará os dele. O objetivo da atividade é sensibilizar sobre a importância de uma 
engenharia de requisitos bem feita.

É esperado que os requisitos que você levantou não sejam exatamente iguais aos do seu colega. Isso é normal e esperado.

Abaixo é fornecida uma ficha de avaliação que deve ser preenchida por você e pelo seu colega, para avaliar os requisitos 
levantados.

### Ficha de avaliação

Para cada um dos itens, responda usando a Escala Likert, de 1 a 5, sendo:
...
1. Os requisitos são claros e compreensíveis.
2. Na melhor das minhas capacidades, acredito que os requisitos estão completos, sem itens faltantes.
3. Não existem requisitos conflitantes.
4. Os requisitos são rastreáveis, permitindo que identificar a origem de cada um deles (e.g. solicitante).
5. Os requisitos estão priorizados, permitindo identificar quais são mais importantes.

#### Avaliação subjetiva

Faça uma avaliação crítica e comparativa entre os requisitos levantados por você e pelo seu colega. 
Aponte pontos fortes e fracos, e sugira melhorias.